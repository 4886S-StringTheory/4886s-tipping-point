 ...
 * v2.9
 * Added automatic bumper for claw
 * v3.0
 * Adjusted for new drive motor positions
 * v3.1
 * Added ring motor
 * Changed claw
 * v3.2
 * Removed ring motor
 * Added 20 point autonomous
 ...
 * v3.4
 * Removed AWP
 * One tap to close/open claw
 * Added PID movement and rotation
 * Now moves lift in inches
 * Made multiple autons, change AUTON_SELECT to change
 * Removed usercontrol functions, moved contents to usercontrol()
 * General cleanup
 * Added some comments
 * v4.0
 * Complete rebuild of robot - complete rebuild of code
 * Added pneumatic claws
 * Added rings
 * 6 motor drive
 * 1 motor lift
 * 600 RPM drive
 * Removed lspeed and related
 * Removed claw motor and related
-* Changed dspeed options to 1 and x
 * Removed helpfunctions.h
 * Removed altvex.h
 * Added stddefs.h
 */